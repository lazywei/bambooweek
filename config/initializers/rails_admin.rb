# RailsAdmin config file. Generated on March 28, 2013 20:52
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['竹塹週預購網站', 'Admin']
  ...
  # config.excluded_models = ['OrderItemship']

  # Include specific models (exclude the others):
  # config.included_models = ['Item', 'Order', 'OrderItemship']
  ...
  #     configure :order_itemships, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your order_itemship.rb model definition
